...
def create_and_preprocess_X_y(nb_input_images=3):
    """
    Create X and y arrays of respective shape (88, 200, 106) and (88, 100, 106) from music images, concatenated from each folder
    """
