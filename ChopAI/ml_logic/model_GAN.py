...
# From other files
from preprocessing_GAN import pixels
...
def train(generator_model, discriminator_model, gan_model, dataset, latent_dim = 100, n_epochs=250, n_batch=15):
    ...
    for i in range(n_epochs): # Enumerate epochs
        ...
        accuracy_on_real, accuracy_on_fake = show_current_discriminator_accuracy(discriminator_model, generator_model, pixels, latent_dim)
